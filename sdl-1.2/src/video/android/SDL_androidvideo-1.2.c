				...
				int width, int height, int bpp, Uint32 flags)
{
	...
	__android_log_print(ANDROID_LOG_INFO, "libSDL","SDL_OPENGL = %d, HWSURFACE: %d, force swmode %d",flags & SDL_OPENGL,flags & SDL_HWSURFACE,SDL_ANDROID_VideoForceSoftwareMode);
